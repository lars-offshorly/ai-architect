...
def v1_fixture() -> dict[str, Any]:
    """Minimal valid v1 app request body — dummy_data_json + generation_json, no v2_manifest."""
    return {
        "dummy_data_json": {
...
def v2_fixture() -> dict[str, Any]:
    """Minimal valid v2 app request body — includes v2_manifest.

    Ready for use once task 4.1 adds v2_manifest to GenerateAppRequest.
    """
    return {
        "dummy_data_json": {
