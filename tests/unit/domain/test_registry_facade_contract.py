...
def test_build_payload_stores_parameter_names_are_locked() -> None:
    ...
    assert list(sig.parameters) == ["self", "bundle_key", "dummy_data_json"]
...
def test_build_payload_stores_dummy_data_json_annotation_is_dict() -> None:
    sig = inspect.signature(RegistryFacade.build_payload_stores)
    assert sig.parameters["dummy_data_json"].annotation == "dict"
