...
class EntityRelationshipDefinition(BaseModel):
    ...
    type: str = Field(description="Relationship type: 'has_many', 'belongs_to', or 'references'.")
    label: str | None = Field(default=None, description="Optional human-readable override label.")
